...
export const metadata = {
  title: "Nilesh | Personal Portfolio",
  description: 'Nilesh is a Full Stack Developer with main focus as Frontend and has a total of 2 years of experience working in the industry.',
}
